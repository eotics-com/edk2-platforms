...
)
{
  ...
  Avail = MmioRead32 (mRngBase + RNG_FIFO_COUNT_OFFSET) & RNG_FIFO_DATA_AVAIL_MASK;
  ...
  *Val = MmioRead32 (mRngBase + RNG_FIFO_DATA_OFFSET);
  ...
  )
{
  ...
  //
  MmioWrite32 (mRngBase + RNG_BIT_COUNT_THRESHOLD_OFFSET, RNG_WARMUP_COUNT);
  ...
  //
  MmioWrite32 (mRngBase + RNG_CTRL_OFFSET,
